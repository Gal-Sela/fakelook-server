...
namespace fakeLook_dal.Migrations
{
    ...
    [Migration("20220316130433_UpateUserModel")]
    partial class UpateUserModel
    {
            ...
            modelBuilder.Entity("fakeLook_models.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Date = new DateTime(2022, 3, 16, 15, 4, 32, 829, DateTimeKind.Local).AddTicks(3851),
                            Description = "post 1",
                            ...
                            UserId = 1,
                            X_Position = 5.9141150675799503,
                            Y_Position = 3.7095281032207437,
                            Z_Position = 16.35935652647504
                        },
                        new
                        {
                            Id = 2,
                            Date = new DateTime(2022, 3, 16, 15, 4, 32, 829, DateTimeKind.Local).AddTicks(3888),
                            Description = "post 2",
                            ImageSorce = "https://s.yimg.com/ny/api/res/1.2/PPu_U6UY8JjEGaR3t4T3wQ--/YXBwaWQ9aGlnaGxhbmRlcjt3PTk2MDtoPTcyMDtjZj13ZWJw/https://s.yimg.com/uu/api/res/1.2/Rffcviow.eCHjmEu2msLJg--~B/aD0xNzU3O3c9MjM0MzthcHBpZD15dGFjaHlvbg--/https://media.zenfs.com/en/insider_articles_922/c6ce8d0b9a7b28f9c2dee8171da98b8f",
                            UserId = 2,
                            X_Position = 21.203017194629815,
                            Y_Position = 39.101971984231163,
                            Z_Position = 17.31890643221038
                        },
                        new
                        {
                            Id = 3,
                            Date = new DateTime(2022, 3, 16, 15, 4, 32, 829, DateTimeKind.Local).AddTicks(3890),
                            Description = "post 3",
                            ImageSorce = "https://s.yimg.com/ny/api/res/1.2/PPu_U6UY8JjEGaR3t4T3wQ--/YXBwaWQ9aGlnaGxhbmRlcjt3PTk2MDtoPTcyMDtjZj13ZWJw/https://s.yimg.com/uu/api/res/1.2/Rffcviow.eCHjmEu2msLJg--~B/aD0xNzU3O3c9MjM0MzthcHBpZD15dGFjaHlvbg--/https://media.zenfs.com/en/insider_articles_922/c6ce8d0b9a7b28f9c2dee8171da98b8f",
                            UserId = 3,
                            X_Position = 47.282590003028773,
                            Y_Position = 17.108967942761911,
                            Z_Position = 10.672023214929338
                        },
                        new
                        {
                            Id = 4,
                            Date = new DateTime(2022, 3, 16, 15, 4, 32, 829, DateTimeKind.Local).AddTicks(3892),
                            Description = "post 4",
                            ImageSorce = "https://s.yimg.com/ny/api/res/1.2/PPu_U6UY8JjEGaR3t4T3wQ--/YXBwaWQ9aGlnaGxhbmRlcjt3PTk2MDtoPTcyMDtjZj13ZWJw/https://s.yimg.com/uu/api/res/1.2/Rffcviow.eCHjmEu2msLJg--~B/aD0xNzU3O3c9MjM0MzthcHBpZD15dGFjaHlvbg--/https://media.zenfs.com/en/insider_articles_922/c6ce8d0b9a7b28f9c2dee8171da98b8f",
                            UserId = 4,
                            X_Position = 13.331610257148657,
                            Y_Position = 3.9136755521570032,
                            Z_Position = 3.437740587931243
                        },
                        new
                        {
                            Id = 5,
                            Date = new DateTime(2022, 3, 16, 15, 4, 32, 829, DateTimeKind.Local).AddTicks(3893),
                            Description = "post 5",
                            ImageSorce = "https://s.yimg.com/ny/api/res/1.2/PPu_U6UY8JjEGaR3t4T3wQ--/YXBwaWQ9aGlnaGxhbmRlcjt3PTk2MDtoPTcyMDtjZj13ZWJw/https://s.yimg.com/uu/api/res/1.2/Rffcviow.eCHjmEu2msLJg--~B/aD0xNzU3O3c9MjM0MzthcHBpZD15dGFjaHlvbg--/https://media.zenfs.com/en/insider_articles_922/c6ce8d0b9a7b28f9c2dee8171da98b8f",
                            UserId = 5,
                            X_Position = 17.576403619109275,
                            Y_Position = 33.238896765652228,
                            Z_Position = 11.845647329592147
                        });
                });
